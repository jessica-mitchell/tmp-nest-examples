...
class StructralPlasticityExample:
    ...
    def create_nodes(self):
        ...
        self.nodes_e = nest.Create(
            "iaf_psc_alpha", self.number_excitatory_neurons, {"synaptic_elements": synaptic_elements}
        )

        self.nodes_i = nest.Create(
            "iaf_psc_alpha", self.number_inhibitory_neurons, {"synaptic_elements": synaptic_elements_i}
        )
